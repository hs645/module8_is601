...
def test_calculator_add(page, fastapi_server):
    ...
    # Wait for the result to appear and then assert its value.
    page.wait_for_selector('#result:has-text("Calculation Result")', timeout=2000)
...
def test_calculator_divide_by_zero(page, fastapi_server):
    ...
    page.wait_for_selector('#result', timeout=2000)
